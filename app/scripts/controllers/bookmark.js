...
app.controller('BookmarksCtrl', function($scope, $routeParams, CategoryService) {
...
app.controller('BookmarkViewCtrl', function($scope, $routeParams, CategoryService, Auth) {
  $scope.category = CategoryService.get($routeParams.catId);
  $scope.bookmarks = CategoryService.bookmarks($routeParams.catId);
...
app.controller('AddBookmarkCtrl', function($scope, $location, CategoryService, Auth) {
